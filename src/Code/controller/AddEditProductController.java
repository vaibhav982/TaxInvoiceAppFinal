...
public class AddEditProductController implements Initializable {
...
//        itemDes.setCellFactory(TextFieldTableCell.forTableColumn());
        ...
        tableID.getSelectionModel().setCellSelectionEnabled(true);
        try{
            float t = 0;
            String SQL = "SELECT Item_Description, Quantity, Rate, PricePerUnit,total from invoice_data";
            ...
            Sample.setText(String.valueOf(t));
        }catch(Exception e){
            e.printStackTrace();
